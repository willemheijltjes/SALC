...
\author
{Willem Heijltjes}
{University of Bath, UK \and \url{http://www.cs.bath.ac.uk/~wbh22/}}
...
%
%\begin{align*}
%	& \trm{[a_1,a_2-   {{\color{red} \lambda x .\lambda y.( }} {{ \color{myGreen} (\lambda z.z)y}} {{ \color{red}) x }} ]}
%\\&\rw_{D} \trm{\{ {{ \color{red}x_1 }}<b_1>.b_1/a_1\}\{ {{ \color{red} x_2 }}<b_2>.b_2/a_2\}[x_1<b_1>,x_2<b_2>\mid x<x>[b_1,b_2- {{\color{red}\lambda y.(}}{{\color{myGreen}(\lambda z.z)y}}{{\color{red})x}}]]}
%\\&\rw_{D} \trm{\{{{\color{red}x_1}}<c_1>.{{\color{red}y_1}}<c_1>c_1/a_1\}\{{{\color{red}x_2}}<c_2>.{{\color{red}y_2}}<c_2>.c_2/a_2\}}
%\\&\quad\qquad\trm{[x_1<c_1>,x_2<c_2>\mid x<x>[y_1<c_1>,y_2<c_2> \mid y<y>[c_1,c_2-{{ \color{red}(}}{{\color{myGreen}(\lambda z.z)y}}{{\color{red})x}}]]]}
%\\&\rw_{D} \trm{\{ {{\color{red}x_1}}<{{\color{myGreen} d_1}},e_1>. {{\color{red} y_1}}<{{\color{myGreen} d_1}},e_1>{{\color{myGreen} d_1}}e_1/a_1\}\{{{\color{red} x_2}}<{{\color{myGreen} d_2}},e_2>.{{\color{red} y_2}}<{{\color{myGreen} d_2}},e_2>.{{\color{myGreen} d_2}}e_2/a_2\}}
...
%\\&\rw_{L} \trm{\{{{\color{red}x_1}}<{{\color{myGreen} d_1}},e_1>.{{\color{red}y_1}}<{{\color{myGreen} d_1}}>{{\color{myGreen} d_1}}e_1/a_1\}\{ {{\color{red}x_2}}<{{\color{myGreen} d_2}},e_2>. {{\color{red}y_2}}<{{\color{myGreen} d_2}}>.{{\color{myGreen} d_2}}e_2/a_2\}}
...
%\\&\rw_{L} \trm{\{ {{\color{red} x_1}}<e_1>. {{\color{red} y_1}}<{{\color{myGreen} d_1}}>{{\color{myGreen} d_1}}e_1/a_1\}\{{{\color{red}x_2}}<e_2>.{{\color{red}y_2}}<{{\color{myGreen} d_2}}>.{{\color{myGreen} d_2}}e_2/a_2\}}
...
%\\&\rw_{D} \trm{\{ {{\color{red} \lambda x_1}} . {{\color{red} y_1}}<{{\color{myGreen} d_1}}>{{\color{myGreen} d_1}}{{\color{red} x_1}}/a_1\}\{  {{\color{red} \lambda x_2.}}. {{\color{red} y_2}}<{{\color{myGreen} d_2}}>.{{\color{myGreen} d_2}}{{\color{red} x_2}}/a_2\}~[y_1<{{\color{myGreen} d_1}}>,y_2<{{\color{myGreen} d_2}}> \mid y<y>[{{\color{myGreen} d_1}},{{\color{myGreen} d_2}}-(\lambda z.z)y]]}
%\end{align*}
...
\hfill
 \scalebox{0.9}{\drv{\drv[yellow]{\drv[magenta]{X_{1} ; | ; X_{2}} ; -[r] ; \drv[green]{Y ; | ; Z_{1}}} ; . ; \drv[cyan]{Z_{1} ; | ; Z_{2}}} $=$ \drv{ \drv[magenta]{X_{1} ; | ; X_{2}} ; -[r] ; \drv[yellow]{ \drv[green]{Y ; | ; Z_{1}} ; . ; \drv[cyan]{Z_{1} ; | ; Z_{2}}}}
} 
\hfill
 \scalebox{0.9}{\drv{ \drv[magenta]{X_{1} ; | ; X_{2}} ; . ; \drv[yellow]{ \drv[green]{X_{2} ; | ; Y} ; -[r] ; \drv[cyan]{Z_{1} ; | ; Z_{2}}}} $=$ \drv{\drv[yellow]{\drv[magenta]{X_{1} ; | ; X_{2}} ; . ; \drv[green]{X_{2} ; | ; Y}} ; -[r] ; \drv[cyan]{Z_{1} ; | ; Z_{2}}}
} 
 \hfill
\scalebox{0.9}{
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item The variable $c$ occurs somewhere in the environment $\overline{[\Gamma]}$.
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\item For all $1 \leq i \leq m$, $y_{i}$ occurs in the environment $\overline{[\Gamma]}$.
	\end{enumerate}
\end{enumerate}
...
\\&\rw_{D} \trm{\{ {{\color{red} \lambda x_1}} . {{\color{red} y_1}}<{{\color{myGreen} d_1}}>{{\color{myGreen} d_1}}{{\color{red} x_1}}/a_1\}\{  {{\color{red} \lambda x_2}}. {{\color{red} y_2}}<{{\color{myGreen} d_2}}>.{{\color{myGreen} d_2}}{{\color{red} x_2}}/a_2\}~[y_1<{{\color{myGreen} d_1}}>,y_2<{{\color{myGreen} d_2}}> \mid y<y>[{{\color{myGreen} d_1}},{{\color{myGreen} d_2}}-(\lambda z.z)y]]}
\end{align*}
%Let $t = \app{(\abs{z}{z})}{y}$ in $\share{u}{z_{1}, z_{2}}{\abs{x}{\abs{y}{\app{t}{x}}}}$ (note $\abs{x}{t} \equiv \fake{x}{x}{t}$). Then by two (\ref{red:absdup}) steps we obtain 
%\\[0.1cm]
%\indent $u \sub{}{\fake{x_{i}}{z_{i}}{\fake{y_{i}}{z_{i}}{z_{i}}}}{z_{i}}_{i \in [2]}\dist{}{\fakedist{x_{i}}{z_{i}}_{i \in [2]}}{\dist{}{\fakedist{y_{i}}{z_{i}}_{i \in [2]}}{\share{}{z_{1}, z_{2}}{\app{t}{x}}}{y}{y}}{x}{x}$
%\\[0.1cm] 
%%%%%%%
%then we can use the rule (\ref{red:appdup}) to duplicate the application, and use (\ref{red:distshare}) to obtain
%\\[0.1cm] 
%$u \sub{}{\fake{x_{i}}{a_{i}, b_{i}}{\fake{y_{i}}{a_{i}}{\app{a_{i}}{b_{i}}}}}{z_{i}}_{i \in [2]} \dist{}{\fakedist{x_{i}}{a_{i}, b_{i}}_{i \in [2]}}{\share{}{b_{1}, b_{2}}{x} \dist{}{\fakedist{y_{i}}{a_{i}}_{i \in [2]}}{\share{}{a_{1}, a_{2}}{t}}{y}{y}}{x}{x}$
%\\[0.1cm]
%%%%%%
%Then (\ref{red:distshare}) to lift the nested distributor and eliminate the distributor using (\ref{red:distelim})
%\\[0.1cm]
%\indent $u \sub{}{\abs{x_{i}}{\fake{y_{i}}{a_{i}}{\app{a_{i}}{x_{i}}}}}{z_{i}}_{i \in [2]} \dist{}{\fakedist{y_{i}}{a_{i}}_{i \in [2]}}{\share{}{a_{1}, a_{2}}{t}}{y}{y}$
\end{example}
