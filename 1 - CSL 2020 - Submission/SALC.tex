...
\begin{example} In the following, we apply the rules (\ref{red:absdup}, \ref{red:absdup}, \ref{red:appdup}, \ref{red:distshare}, \ref{red:distshare}, \ref{red:distelim}). We make the spine red to show that it is duplicated. The subterm not part of the spine is in green. 
\begin{align*}
	& \trm{[a_1,a_2-   {{\color{red} \lambda x .\lambda y.( }} {{ \color{myGreen} (\lambda z.z)y}} {{ \color{red}) x }} ]}
\\&\rw_{D} \trm{\{ {{ \color{red}x_1 }}<b_1>.b_1/a_1\}\{ {{ \color{red} x_2 }}<b_2>.b_2/a_2\}[x_1<b_1>,x_2<b_2>\mid x<x>[b_1,b_2- {{\color{red}\lambda y.(}}{{\color{myGreen}(\lambda z.z)y}}{{\color{red})x}}]]}
\\&\rw_{D} \trm{\{{{\color{red}x_1}}<c_1>.{{\color{red}y_1}}<c_1>c_1/a_1\}\{{{\color{red}x_2}}<c_2>.{{\color{red}y_2}}<c_2>.c_2/a_2\}}
