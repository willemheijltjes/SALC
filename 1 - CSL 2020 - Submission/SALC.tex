...
\end{description}
While each of these duplication strategies has been expressed in graphs and labelled calculi, the atomic lambda-calculus was the first term calculus 
