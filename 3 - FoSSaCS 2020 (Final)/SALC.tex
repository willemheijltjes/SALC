...
%
\authorrunning{Sherratt et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{
        Friedrich-Schiller-Universit\"{a}t Jena, Germany \\ \email{david.rhys.sherratt@uni-jena.de}
\\ \and	University of Bath, UK. \\ \email{w.b.heijltjes@bath.ac.uk}
\\ \and Red Hat, Inc. Norway.   \\ \email{teg@jklm.no} 
\\ \and Institut de Recherche en Informatique Fondamentale, CNRS, Universit\'e de Paris. France. \\ \email{parigot@irif.fr}
}
%
